...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	else
	{
		...
		HRESULT hr;
		UINT maxQuality;
		hr = m_d3dDevice->CheckMultisampleQualityLevels(swapChainDesc.Format, swapChainDesc.SampleDesc.Count, &maxQuality);
		...
		swapChainDesc.SampleDesc.Quality = maxQuality;
